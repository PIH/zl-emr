...
GROUP_CONCAT(DISTINCT reason_n.name SEPARATOR ' | ') type_of_visit, e.visit_id, pr.birthdate, pr.birthdate_estimated, ahe_section.user_generated_id as section_communale_CDC_ID
